      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[25%_50%_25%] gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-center md:text-left italic text-[#FDF8F3]">
              Smart-ass wisdom, straight from the Gulf of America!
            </p>
          </div>
          ...
          <div className="flex items-center justify-center">
            ...
            >
              "If you took my advice seriously, that's on you."
            </blockquote>
          </div>
        ...
        <div className="border-t border-[#FDF8F3]/20 pt-6 text-center">
          <p className="text-sm text-[#FDF8F3] mb-1">
            © 2025 DewBob.com — All rights preserved for mockery and misuse.
          </p>
        </div>
      </Container>
    </footer>
